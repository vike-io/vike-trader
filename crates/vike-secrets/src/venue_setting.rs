...
mod tests {
    ...
    /// renderer's callers at three, and this file is one of them *"the definition itself, and its
    /// own tests"*. A test file is not a fold, but the gate's question is who CALLS the renderer
    /// and the honest answer is to put the test where the renderer lives.
