...
pub use coverage::{find_gaps, InstrumentCoverage, InstrumentKey, KindDays, PartialDay};
...
pub use store_kind::{store_kind, CommitKey, Partition, StoreKind, STORE_KINDS};

#[cfg(feature = "hist-datafusion")]
pub use datafusion_hist::{load_policy, save_policy, StoreSourcePolicy};
#[cfg(feature = "hist-datafusion")]
