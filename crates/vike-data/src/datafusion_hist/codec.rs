...
use vike_model::{
    AssetClass, Bar, BookLevel, BookUpdate, BookUpdateKind, EquitySample, QuoteTick,
    SymbolProperties, TickScheme, TradeTick,
};
...
mod tests {
    ...
    fn properties_codec_refuses_an_unknown_asset_class_word() {
        ...
        assert!(
            format!("{err}").contains("Perpetual"),
            "the refusal names the offending word: {err}"
        );
    }
