...
use datafusion::prelude::{col, lit, ParquetReadOptions, SessionConfig, SessionContext};
...
use super::manifest::{read_manifest, FileEntry};
use super::{file_url, part_dir, q, DataFusionHist};
        ...
        self.rt.block_on(async move {
            ...
            for url in urls {
                ...
                if let Some(ref s) = symbol_filter {
                    if df.schema().field_with_unqualified_name("symbol_col").is_ok() {
