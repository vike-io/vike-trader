...
pub const STORE_KINDS: &[StoreKind] = &[
    StoreKind {
        ...
        commit_keys: &[
            ...
            // ⚠ THE ENGINE'S OWN FETCH — `backtest --fetch`, which is what `vike-cli data fetch`
            ...
            // The SYNTHETIC tape `vike-cli data seed-demo` / `backtest --seed-demo` writes. It was
            // missing from this row until 2026-09-07, so the one series a fresh install is
