//! `kind=exec_funding` HistStore series — the realized perp funding-payment log (Tier-2), NOT market
...
//! It proves realized funding (`kind=exec_funding`) and a symbol's market prints (`kind=trade`) NEVER
...
mod datafusion_tests {
    ...
    /// The namespace guard: realized funding (`kind=exec_funding`) and a symbol's MARKET prints
