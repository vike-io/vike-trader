...
pub const CONSUMPTION: &[Consumption] = &[
    ...
    Consumption {
        key: "flags.reconcile",
        by: Consumer::At {
            // …and crates/vike-app/src/main.rs's `App::new`, which now takes the same resolved
            // value instead of `reconcile_config::reconcile_enabled(&recon_env)`.
            file: "crates/vike-tradehub/src/tradehub_cli.rs",
            needle: "let recon_enabled = flags.reconcile;",
        },
    },
    Consumption {
