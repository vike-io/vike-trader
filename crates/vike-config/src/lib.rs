...
// `docs/superpowers/specs/2026-09-09-datahub-market-data-wire-design.md`). Its datahub sibling stays
// module-qualified only because nothing outside this crate had reached for it yet.
pub use config::{Config, ConfigPatch, DEFAULT_BACKTEST_ADDR};
pub use consumed::{
...
pub use load::{
    NO_SETTINGS_DIRECTORY_WARNING, Settings, load, load_with_cli, load_with_store, settings_files,
};
pub use mirror::{SECTION_FILES, apply_rows, file_for_section, rows_from_files, section_values};
...
pub use provenance::{
    ...
    describe_with_store, precedence_line,
};
...
pub use write::{
    LockBudget, SETTINGS_LOCK_FILE, SettingsFile, SettingsWrite, SettingsWriteError,
