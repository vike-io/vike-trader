...
/// a resolution nothing is running on. Every shipped disclosure surface calls
/// [`describe_with_source`] with the arm it read; this entry point survives for tests and for a
/// caller that genuinely has no store to offer.
