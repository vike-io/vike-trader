//! Unit tests for the PURE generator (`vike_user_strategies::gen`) on synthetic trees — the exact
...
use vike_user_strategies::gen::{render, scan, valid_name, ScannedStrategy};
