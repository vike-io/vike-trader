//! The impure caller of `src/gen.rs` (which this script `include!`s — the vike-buildinfo
...
//! `vike-model/src/state_path.rs`. Build scripts run in a source checkout by construction (the
