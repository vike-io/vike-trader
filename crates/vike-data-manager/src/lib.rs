...
pub use view::{
    ...
    coverage_label, filter_tree, global_span, has_gaps, has_partial_days, is_stale,
    partial_days_from_coverage, partial_days_label, polymarket_proxy_ui, proxy_display,
    proxy_to_store, stored_catalog_grid, stored_catalog_ui, symbol_partial_label,
};
