...
use crate::error_kind::{
    classify_venue, reject_reason, retry_exhausted_reason, submit_disposition, ExecErrorPolicy,
    SubmitAttempt, SubmitDisposition, SubmitRetryBudget, VenueTaxonomy,
};
use crate::halt;
...
mod submit_error_policy_tests {
    use super::*;
    use crate::transport::{ErrorKind, E_TIMEOUT_AMBIGUOUS};
...
mod cancel_event_tests {
    use super::{cancel_event, CancelOutcome};
