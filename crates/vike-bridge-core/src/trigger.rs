...
mod tests {
    ...
    use super::{deny_unsupported_trigger_by, venue_trigger_by, TriggerByOutcome};
    ...
    fn deny_gate_fires_only_on_unsupported_trigger_rows() {
        ...
        assert!(deny_unsupported_trigger_by("binance-perp", &req("binance", "stop", Some(Mark)))
            .is_none());
        ...
        assert!(deny_unsupported_trigger_by(
            "hyperliquid",
        ...
        assert!(deny_unsupported_trigger_by(
            "hyperliquid",
            &req("hyperliquid", "limit", Some(Last))
        )
        .is_none());
        assert!(
