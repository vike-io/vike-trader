...
//! the write-ahead command journal ([`vike_journal`], mmap segments that PRUNE), the
...
//! collector — it opens the journal through the lock-free [`vike_journal::CommandJournal::
