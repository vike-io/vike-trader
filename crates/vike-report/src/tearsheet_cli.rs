...
use crate::report::{LiveTearsheet, DAILY_PERIODS_PER_YEAR};
...
fn build_from_store(
    ...
    use crate::{
        backfill_excursions, equity_curve_from_store, equity_curve_from_trades, fills_from_journal,
        mtm_curve_from_store, mtm_equity_curve, reconstruct_trades, RuntimeStats,
    };
