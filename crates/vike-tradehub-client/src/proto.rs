...
pub use vike_datahub_client::proto::{
    read_frame, read_frame_raw, read_frame_raw_capped, write_frame, MAX_FRAME_LEN,
};
...
mod tests {
    ...
    fn the_datahub_entry_shadows_no_named_capability() {
        ...
        for named in [FEATURE_STRATEGY_VERBS, FEATURE_SETTINGS_SHOW, FEATURE_MOUNT_VERBS] {
