...
//! (`crate::remote_handle::RemoteCoreHandle::connect`) runs it under [`Scope::Read`] and then
//! sends its `Subscribe`; the control paths (`crate::remote_control::RemoteControlHandle::connect`
//! and `crate::remote_control::preview_command`) run it under [`Scope::Write`] and stay in the
