...
impl CexBars {
    ...
    /// `-SWAP` for okx, all of them additionally gated on `vike_bridge_core::mark_streams_enabled`),
...
/// (`crates/bridges/bybit/src/market_feed.rs`'s
...
fn cex_status_row_is_unambiguous(status_writer_lanes: usize) -> bool {
...
mod cex_row_admission {
    ...
    //! WRITE-FREQUENCY ASYMMETRY (`vike_ops::reconcile_config`'s `health_from_feed_status` argues
    ...
    use super::cex_status_row_is_unambiguous;
