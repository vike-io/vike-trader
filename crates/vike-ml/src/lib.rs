...
/// The ask/tell Bayesian sampler (TPE). Came down from `vike-backtest`'s harness, whose own doc
/// already called this half "store-free and pure"; at 50 it was out of reach of the study host
/// at 35, which could sweep a grid and nothing cleverer. See the module doc.
pub mod tpe;
pub mod train;
