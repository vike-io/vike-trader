...
pub(crate) fn encode_request_contract_data(
    request_id: i32,
    contract: &Contract,
) -> Result<Vec<u8>, Error> {
...
pub(crate) fn encode_request_matching_symbols(
    request_id: i32,
    pattern: &str,
) -> Result<Vec<u8>, Error> {
    use crate::messages::encode_protobuf_message;
...
pub(crate) fn encode_request_market_rule(market_rule_id: i32) -> Result<Vec<u8>, Error> {
    use crate::messages::encode_protobuf_message;
    use prost::Message;
    let request = crate::proto::MarketRuleRequest { market_rule_id: Some(market_rule_id) };
    Ok(encode_protobuf_message(
...
pub(crate) fn encode_request_smart_components(
    request_id: i32,
    bbo_exchange: &str,
) -> Result<Vec<u8>, Error> {
    use crate::messages::encode_protobuf_message;
...
pub(crate) fn encode_cancel_option_computation(
    ...
    match message_type {
        ...
        OutgoingMessages::CancelImpliedVolatility => {
            let request =
                crate::proto::CancelCalculateImpliedVolatility { req_id: Some(request_id) };
            Ok(encode_protobuf_message(
