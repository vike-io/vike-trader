...
impl<S> OptionBuilder<Symbol, S, Missing> {
    ...
    pub fn expires_on(
        ...
        month: u8,
        day: u8,
    ) -> OptionBuilder<Symbol, S, ExpirationDate> {
...
impl ForexBuilder {
    ...
    pub fn new(base: impl Into<Currency>, quote: impl Into<Currency>) -> Self {
        ForexBuilder { base: base.into(), quote: quote.into(), exchange: "IDEALPRO".into() }
    }
...
impl CryptoBuilder {
    ...
    pub fn new(symbol: impl Into<Symbol>) -> Self {
        CryptoBuilder { symbol: symbol.into(), exchange: "PAXOS".into(), currency: "USD".into() }
    }
...
impl SpreadBuilder {
    ...
    pub fn new() -> Self {
        SpreadBuilder { legs: Vec::new(), currency: "USD".into(), exchange: "SMART".into() }
    }
}
...
impl SpreadBuilder {
    ...
    pub fn add_leg(self, contract_id: i32, action: LegAction) -> LegBuilder {
        LegBuilder { parent: self, leg: Leg { contract_id, action, ratio: 1, exchange: None } }
    }
