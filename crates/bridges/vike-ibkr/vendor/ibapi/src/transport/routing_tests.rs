...
fn test_notice_from_decoded_preserves_rich_payload() {
    ...
    let expected =
        OffsetDateTime::from_unix_timestamp_nanos(1_700_000_000_000_i128 * 1_000_000).unwrap();
...
fn test_determine_routing_protobuf_open_order() {
    let bytes =
        crate::proto::OpenOrder { order_id: Some(58), ..Default::default() }.encode_to_vec();
...
fn test_determine_routing_protobuf_execution_data_uses_nested_order_id() {
    ...
    let bytes = crate::proto::ExecutionDetails {
        req_id: Some(-1),
        contract: None,
        execution: Some(crate::proto::Execution { order_id: Some(58), ..Default::default() }),
    }
    .encode_to_vec();
...
fn test_determine_routing_protobuf_request_id_message() {
    ...
    let bytes =
        crate::proto::AccountSummary { req_id: Some(314), ..Default::default() }.encode_to_vec();
