...
impl<'a> RequestBuilder<'a> {
    ...
    pub fn new(client: &'a Client) -> Self {
        Self { client, request_id: client.next_request_id() }
    }
    ...
    pub async fn send_with_context<T>(
        self,
        message: Vec<u8>,
...
impl<'a> OrderRequestBuilder<'a> {
    ...
    pub fn new(client: &'a Client) -> Self {
        Self { client, order_id: client.next_order_id() }
    }
    ...
    T: Send + 'static,
{
    ...
    pub fn new_with_components(
        ...
        Self { message_bus, context, _phantom: PhantomData }
    }
    ...
    pub async fn send_with_request_id<D>(
        self,
        request_id: i32,
        message: Vec<u8>,
    ) -> Result<Subscription<T>, Error>
