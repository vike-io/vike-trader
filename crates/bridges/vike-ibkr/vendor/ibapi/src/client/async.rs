...
impl Client {
    ...
    pub fn notice_stream(
        &self,
    ) -> Result<crate::subscriptions::notice_stream::async_impl::NoticeStream, Error> {
    ...
    pub fn market_data<'a>(
        &'a self,
        contract: &'a Contract,
    ) -> crate::market_data::builder::MarketDataBuilder<'a, Self> {
    ...
    pub(crate) async fn create_order_update_subscription(
        &self,
    ) -> Result<AsyncInternalSubscription, Error> {
