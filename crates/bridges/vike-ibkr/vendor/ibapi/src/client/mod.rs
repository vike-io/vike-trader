...
pub mod blocking {
    ...
    pub(crate) use crate::client::builders::blocking::{
        ClientRequestBuilders, SubscriptionBuilderExt,
    };
    ...
    pub use crate::subscriptions::sync::{
        SharesChannel, Subscription, SubscriptionIter, SubscriptionOwnedIter,
        SubscriptionTimeoutIter, SubscriptionTryIter,
    };
}
