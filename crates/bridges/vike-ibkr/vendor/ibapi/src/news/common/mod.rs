...
pub(crate) fn encode_contract_news_request(
    request_id: i32,
    contract: &Contract,
    provider_codes: &[&str],
) -> Result<Vec<u8>, Error> {
    ...
    crate::market_data::realtime::common::encoders::encode_request_market_data(
        request_id,
        contract,
...
pub(crate) fn encode_broad_tape_news_request(
    request_id: i32,
    provider_code: &str,
) -> Result<Vec<u8>, Error> {
