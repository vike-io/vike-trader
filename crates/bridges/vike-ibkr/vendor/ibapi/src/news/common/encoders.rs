...
pub(in crate::news) fn encode_request_news_providers() -> Result<Vec<u8>, crate::Error> {
    crate::proto::encoders::encode_empty_proto!(
        ...
        crate::messages::OutgoingMessages::RequestNewsProviders
    )
}

pub(in crate::news) fn encode_request_news_bulletins(
    all_messages: bool,
) -> Result<Vec<u8>, crate::Error> {
    use crate::messages::{encode_protobuf_message, OutgoingMessages};
    use crate::proto::encoders::some_bool;
    use prost::Message;
    let request = crate::proto::NewsBulletinsRequest { all_messages: some_bool(all_messages) };
...
pub(in crate::news) fn encode_cancel_news_bulletin() -> Result<Vec<u8>, crate::Error> {
    crate::proto::encoders::encode_empty_proto!(
        CancelNewsBulletins,
        crate::messages::OutgoingMessages::CancelNewsBulletin
    )
}
