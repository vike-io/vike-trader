...
impl Client {
    ...
    pub async fn news_providers(&self) -> Result<Vec<NewsProvider>, Error> {
        self.check_server_version(
            server_versions::REQ_NEWS_PROVIDERS,
            "It does not support news providers requests.",
        )?;

        let request = encoders::encode_request_news_providers()?;
        let mut subscription =
            self.send_shared_request(OutgoingMessages::RequestNewsProviders, request).await?;
    ...
    pub async fn news_bulletins(
        ...
        let internal_subscription =
            self.send_shared_request(OutgoingMessages::RequestNewsBulletins, request).await?;
    ...
    pub async fn historical_news(
        ...
        self.check_server_version(
            server_versions::REQ_HISTORICAL_NEWS,
    ...
    pub async fn news_article(
        ...
        self.check_server_version(
            server_versions::REQ_NEWS_ARTICLE,
