...
impl StreamDecoder<WshMetadata> for WshMetadata {
    const RESPONSE_MESSAGE_IDS: &'static [IncomingMessages] =
        &[IncomingMessages::WshMetaData, IncomingMessages::Error];
    ...
    fn cancel_message(
        ...
        let request_id = error_helpers::require_request_id_for(
            request_id,
            "encode cancel wsh metadata message",
        )?;
...
impl StreamDecoder<WshEventData> for WshEventData {
    const RESPONSE_MESSAGE_IDS: &'static [IncomingMessages] =
        &[IncomingMessages::WshEventData, IncomingMessages::Error];
    ...
    fn cancel_message(
        ...
        let request_id = error_helpers::require_request_id_for(
            request_id,
            "encode cancel wsh event data message",
        )?;
