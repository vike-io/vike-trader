...
pub(in crate::wsh) fn decode_metadata_message(
    message: &ResponseMessage,
) -> Result<WshMetadata, Error> {
...
pub(in crate::wsh) fn decode_event_data_message(
    message: &ResponseMessage,
