...
pub(crate) fn encode_auto_open_orders(auto_bind: bool) -> Result<Vec<u8>, Error> {
    ...
    use prost::Message;
    let request = crate::proto::AutoOpenOrdersRequest { auto_bind: some_bool(auto_bind) };
    Ok(crate::messages::encode_protobuf_message(
...
pub(crate) fn encode_completed_orders(api_only: bool) -> Result<Vec<u8>, Error> {
    use crate::proto::encoders::some_bool;
    use prost::Message;
    let request = crate::proto::CompletedOrdersRequest { api_only: some_bool(api_only) };
    Ok(crate::messages::encode_protobuf_message(
...
pub(crate) fn encode_executions(
    request_id: i32,
