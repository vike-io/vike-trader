...
pub use conditions::{
    ExecutionCondition, ExecutionConditionBuilder, MarginCondition, MarginConditionBuilder,
    PercentChangeCondition, PercentChangeConditionBuilder, PriceCondition, PriceConditionBuilder,
    TimeCondition, TimeConditionBuilder, VolumeCondition, VolumeConditionBuilder,
};
...
impl OrderStatusKind {
    ...
    pub fn is_active(self) -> bool {
        matches!(
            self,
            Self::PreSubmitted | Self::PendingSubmit | Self::PendingCancel | Self::Submitted
        )
    }
