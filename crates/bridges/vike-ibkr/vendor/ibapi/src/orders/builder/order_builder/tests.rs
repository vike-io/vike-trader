...
fn test_trailing_stop_limit() {
    ...
    let builder =
        OrderBuilder::new(&client, &contract).sell(100).trailing_stop_limit(5.0, 95.0, 0.50);
...
fn test_order_attributes() {
    ...
    let builder =
        OrderBuilder::new(&client, &contract).buy(100).limit(50.00).hidden().outside_rth();
...
fn test_oca_group_settings() {
    ...
    let builder =
        OrderBuilder::new(&client, &contract).buy(100).limit(50.00).oca_group("TEST_OCA", 2);
...
fn test_custom_order_type() {
    ...
    let builder =
        OrderBuilder::new(&client, &contract).buy(100).order_type(OrderType::PeggedToStock);
...
fn test_bracket_order_missing_entry() {
    ...
    let bracket =
        OrderBuilder::new(&client, &contract).buy(100).bracket().take_profit(55.0).stop_loss(45.0);
...
fn test_bracket_order_missing_take_profit() {
    ...
    let bracket =
        OrderBuilder::new(&client, &contract).buy(100).bracket().entry_limit(50.0).stop_loss(45.0);
