...
fn validate_pct_vol(field: &'static str, value: f64) -> Result<(), ValidationError> {
    if !(MIN_PCT_VOL..=MAX_PCT_VOL).contains(&value) {
        Err(ValidationError::InvalidPercentage { field, value, min: MIN_PCT_VOL, max: MAX_PCT_VOL })
    } else {
        Ok(())
    }
}
...
fn build_windowed_pct_vol(
    ...
    if let Some(v) = start_pct_vol {
        ...
        params.push(TagValue { tag: "startPctVol".to_string(), value: v.to_string() });
    }
    if let Some(v) = end_pct_vol {
        validate_pct_vol("end_pct_vol", v)?;
        params.push(TagValue { tag: "endPctVol".to_string(), value: v.to_string() });
    }
    if let Some(v) = start_time {
        params.push(TagValue { tag: "startTime".to_string(), value: v });
    }
    if let Some(v) = end_time {
        params.push(TagValue { tag: "endTime".to_string(), value: v });
    }
    if let Some(v) = no_take_liq {
        params.push(TagValue { tag: "noTakeLiq".to_string(), value: v.to_field() });
    }

    Ok(AlgoParams { strategy: strategy.to_string(), params })
}
...
impl From<String> for AlgoParams {
    fn from(strategy: String) -> Self {
        Self { strategy, params: Vec::new() }
    }
}

impl From<&str> for AlgoParams {
    fn from(strategy: &str) -> Self {
        Self { strategy: strategy.to_string(), params: Vec::new() }
    }
}
...
impl VwapBuilder {
    ...
    pub fn build(self) -> Result<AlgoParams, ValidationError> {
        ...
        if let Some(v) = self.max_pct_vol {
            ...
            params.push(TagValue { tag: "maxPctVol".to_string(), value: v.to_string() });
        }
        ...
        if let Some(v) = self.allow_past_end_time {
            params.push(TagValue { tag: "allowPastEndTime".to_string(), value: v.to_field() });
        }
        if let Some(v) = self.no_take_liq {
            params.push(TagValue { tag: "noTakeLiq".to_string(), value: v.to_field() });
        }
        if let Some(v) = self.speed_up {
            params.push(TagValue { tag: "speedUp".to_string(), value: v.to_field() });
        }

        Ok(AlgoParams { strategy: "Vwap".to_string(), params })
    }
}
// === TWAP Builder ===
...
impl TwapBuilder {
    ...
    pub fn build(self) -> Result<AlgoParams, ValidationError> {
        ...
        if let Some(v) = self.strategy_type {
            params
                .push(TagValue { tag: "strategyType".to_string(), value: v.as_str().to_string() });
        }
        if let Some(v) = self.start_time {
            params.push(TagValue { tag: "startTime".to_string(), value: v });
        }
        ...
        Ok(AlgoParams { strategy: "Twap".to_string(), params })
    }
}
...
impl PctVolBuilder {
    ...
    pub fn build(self) -> Result<AlgoParams, ValidationError> {
        ...
        if let Some(v) = self.pct_vol {
            ...
            params.push(TagValue { tag: "pctVol".to_string(), value: v.to_string() });
        }
        if let Some(v) = self.start_time {
            params.push(TagValue { tag: "startTime".to_string(), value: v });
        }
        ...
        Ok(AlgoParams { strategy: "PctVol".to_string(), params })
    }
}
...
impl ArrivalPriceBuilder {
    ...
    pub fn build(self) -> Result<AlgoParams, ValidationError> {
        ...
        if let Some(v) = self.risk_aversion {
            params
                .push(TagValue { tag: "riskAversion".to_string(), value: v.as_str().to_string() });
        }
        if let Some(v) = self.start_time {
            params.push(TagValue { tag: "startTime".to_string(), value: v });
        }
        ...
        if let Some(v) = self.force_completion {
            params.push(TagValue { tag: "forceCompletion".to_string(), value: v.to_field() });
        }
        if let Some(v) = self.allow_past_end_time {
            params.push(TagValue { tag: "allowPastEndTime".to_string(), value: v.to_field() });
        }

        Ok(AlgoParams { strategy: "ArrivalPx".to_string(), params })
    }
}
// === Adaptive Builder ===
...
impl AdaptiveBuilder {
    ...
    pub fn build(self) -> Result<AlgoParams, ValidationError> {
        ...
        Ok(AlgoParams { strategy: "Adaptive".to_string(), params })
    }
}
// === Close Price Builder ===
...
impl ClosePriceBuilder {
    ...
    pub fn build(self) -> Result<AlgoParams, ValidationError> {
        ...
        Ok(AlgoParams { strategy: "ClosePx".to_string(), params })
    }
}
// === Dark Ice Builder ===
...
impl DarkIceBuilder {
    ...
    pub fn build(self) -> Result<AlgoParams, ValidationError> {
        ...
        if let Some(v) = self.display_size {
            params.push(TagValue { tag: "displaySize".to_string(), value: v.to_string() });
        }
        if let Some(v) = self.start_time {
            params.push(TagValue { tag: "startTime".to_string(), value: v });
        }
        ...
        Ok(AlgoParams { strategy: "DarkIce".to_string(), params })
    }
}
...
impl AccumulateDistributeBuilder {
    ...
    pub fn build(self) -> Result<AlgoParams, ValidationError> {
        ...
        if let Some(v) = self.component_size {
            params.push(TagValue { tag: "componentSize".to_string(), value: v.to_string() });
        }
        if let Some(v) = self.time_between_orders {
            params.push(TagValue { tag: "timeBetweenOrders".to_string(), value: v.to_string() });
        }
        if let Some(v) = self.randomize_time_20 {
            params.push(TagValue { tag: "randomizeTime20".to_string(), value: v.to_field() });
        }
        if let Some(v) = self.randomize_size_55 {
            params.push(TagValue { tag: "randomizeSize55".to_string(), value: v.to_field() });
        }
        if let Some(v) = self.give_up {
            params.push(TagValue { tag: "giveUp".to_string(), value: v.to_string() });
        }
        if let Some(v) = self.catch_up {
            params.push(TagValue { tag: "catchUp".to_string(), value: v.to_field() });
        }
        if let Some(v) = self.wait_for_fill {
            params.push(TagValue { tag: "waitForFill".to_string(), value: v.to_field() });
        }
        if let Some(v) = self.active_time_start {
            params.push(TagValue { tag: "activeTimeStart".to_string(), value: v });
        }
        if let Some(v) = self.active_time_end {
            params.push(TagValue { tag: "activeTimeEnd".to_string(), value: v });
        }

        Ok(AlgoParams { strategy: "AD".to_string(), params })
    }
}
...
impl BalanceImpactRiskBuilder {
    ...
    pub fn build(self) -> Result<AlgoParams, ValidationError> {
        ...
        Ok(AlgoParams { strategy: "BalanceImpactRisk".to_string(), params })
    }
}
...
impl MinimiseImpactBuilder {
    ...
    pub fn build(self) -> Result<AlgoParams, ValidationError> {
        ...
        Ok(AlgoParams { strategy: "MinImpact".to_string(), params })
    }
}
...
impl PctVolPriceBuilder {
    ...
    pub fn build(self) -> Result<AlgoParams, ValidationError> {
        ...
        if let Some(v) = self.delta_pct_vol {
            ...
            params.push(TagValue { tag: "deltaPctVol".to_string(), value: v.to_string() });
        }
        if let Some(v) = self.min_pct_vol_4_px {
            validate_pct_vol("min_pct_vol_4_px", v)?;
            params.push(TagValue { tag: "minPctVol4Px".to_string(), value: v.to_string() });
        }
        if let Some(v) = self.max_pct_vol_4_px {
            validate_pct_vol("max_pct_vol_4_px", v)?;
            params.push(TagValue { tag: "maxPctVol4Px".to_string(), value: v.to_string() });
        }
        if let Some(v) = self.start_time {
            params.push(TagValue { tag: "startTime".to_string(), value: v });
        }
        ...
        Ok(AlgoParams { strategy: "PctVolPx".to_string(), params })
    }
}
...
impl AccuDistrBuilder {
    ...
    pub fn build(self) -> Result<AlgoParams, ValidationError> {
        ...
        if let Some(v) = self.route_order_type {
            params.push(TagValue { tag: "routeOrderType".to_string(), value: v });
        }
        if let Some(v) = self.component_size {
            params.push(TagValue { tag: "componentSize".to_string(), value: v.to_string() });
        }
        ...
        if let Some(v) = self.active_time_tz {
            params.push(TagValue { tag: "activeTimeTz".to_string(), value: v });
        }

        Ok(AlgoParams { strategy: "AccuDistr".to_string(), params })
    }
}
#[cfg(test)]
