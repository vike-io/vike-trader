use super::*;
use crate::common::test_utils::wire_enum::{
    check_wire_enum_rejects_unknown, check_wire_enum_round_trip,
};
...
fn execution_side_from_str_rejects_unknown() {
    ...
    check_wire_enum_rejects_unknown::<ExecutionSide>(&[
        "", "INVALID", "bot", "sld", "BUY", "SELL", "SSHORT", "SLONG",
    ]);
}
