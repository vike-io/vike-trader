...
use crate::testdata::builders::market_data::{
    bid_ask_tick, depth_market_data_description, market_depth_response, mid_point_tick,
    mkt_depth_exchanges_response, realtime_bar_tick, tick_generic, tick_price, tick_size,
    tick_string, trade_tick, BidAskTickResponse, MidPointTickResponse, TickGenericResponse,
    TickPriceResponse, TickSizeResponse, TickStringResponse, TradeTickResponse,
};
...
mod realtime_bar_tests {
    ...
    fn test_decode_realtime_bar_through_wrapper() {
        let mut message =
            proto_response(crate::messages::IncomingMessages::RealTimeBars, fixture());
...
mod trade_tick_tests {
    ...
    fn test_decode_trade_tick_proto_invalid_type() {
        ...
        let err = decode_trade_tick_proto(&fixture(3).encode_proto())
            .expect_err("should reject bid/ask tick type");
    ...
    fn test_decode_trade_tick_proto_missing_payload() {
        ...
        let msg =
            crate::proto::TickByTickData { req_id: Some(9000), tick_type: Some(1), tick: None };
    ...
    fn test_decode_trade_tick_through_wrapper() {
        let mut message = proto_response(
            crate::messages::IncomingMessages::TickByTick,
...
mod bid_ask_tests {
    ...
    fn test_decode_bid_ask_proto_attributes() {
        for (mask, expected_bid_past_low, expected_ask_past_high) in
            [(0, false, false), (1, true, false), (2, false, true), (3, true, true)]
        {
            let bid_ask =
                decode_bid_ask_tick_proto(&fixture(mask).encode_proto()).expect("decode failed");
            assert_eq!(
    ...
    fn test_decode_bid_ask_proto_invalid_type() {
        ...
        let msg =
            crate::proto::TickByTickData { req_id: Some(9000), tick_type: Some(1), tick: None };
        let err = decode_bid_ask_tick_proto(&msg.encode_to_vec())
            .expect_err("should reject last tick type");
        assert!(err.to_string().contains("Unexpected tick_type"));
    }
}
...
mod mid_point_tests {
    ...
    fn test_decode_mid_point_tick_proto_invalid_type() {
        let msg =
            crate::proto::TickByTickData { req_id: Some(9000), tick_type: Some(1), tick: None };
        let err = decode_mid_point_tick_proto(&msg.encode_to_vec())
            .expect_err("should reject last tick type");
        assert!(err.to_string().contains("Unexpected tick_type"));
    }
}
...
mod market_depth_tests {
    ...
    fn test_decode_market_depth_proto_missing_data() {
        let msg = crate::proto::MarketDepth { req_id: Some(9000), market_depth_data: None };
        let err =
            decode_market_depth_proto(&msg.encode_to_vec()).expect_err("missing data should error");
        assert!(
    ...
    fn test_decode_market_depth_l2_proto() {
        ...
        let depth =
            decode_market_depth_l2_proto(&proto_msg.encode_to_vec()).expect("decode failed");
...
mod tick_price_tests {
    ...
    fn test_decode_tick_price_proto_with_size() {
        ...
        let result =
            decode_tick_price_proto(&fixture(1, 0x5).encode_proto()).expect("decode failed");
        match result {
    ...
    fn test_decode_tick_price_proto_unknown_type() {
        ...
        let proto_msg =
            tick_price().tick_type(99).price(42.0).size(10.0).attr_mask(0x2).encode_proto();
...
mod tick_option_computation_tests {
    ...
    fn test_decode_tick_option_computation_proto() {
        ...
        let result = decode_tick_option_computation_proto(&proto_msg.encode_to_vec())
...
mod tick_request_parameters_tests {
    ...
    fn test_decode_tick_request_parameters_proto() {
        ...
        let result = decode_tick_request_parameters_proto(&proto_msg.encode_to_vec())
            .expect("decode failed");
...
mod market_data_type_tests {
    ...
    fn test_decode_market_data_type_proto_helper() {
        let proto_msg =
            crate::proto::MarketDataType { req_id: Some(9000), market_data_type: Some(3) };
        assert_eq!(
        ...
        let proto_msg =
            crate::proto::MarketDataType { req_id: Some(9000), market_data_type: Some(99) };
        assert_eq!(
            decode_market_data_type_proto(&proto_msg.encode_to_vec()).unwrap(),
    ...
    fn test_decode_market_data_type_proto_through_tick_types() {
        ...
        let proto_msg =
            crate::proto::MarketDataType { req_id: Some(9000), market_data_type: Some(3) };
        let mut message = proto_response(
            crate::messages::IncomingMessages::MarketDataType,
    ...
    fn test_decode_tick_req_params_proto_through_tick_types() {
        ...
        let mut message = proto_response(
            crate::messages::IncomingMessages::TickReqParams,
            proto_msg.encode_to_vec(),
        );
        let context = DecoderContext::new(server_versions::PROTOBUF, None);
