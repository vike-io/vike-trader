...
const END_DATE_FORMAT: &[FormatItem] =
...
pub(crate) fn encode_cancel_historical_data(request_id: i32) -> Result<Vec<u8>, Error> {
    crate::proto::encoders::encode_cancel_by_id!(
        ...
        crate::messages::OutgoingMessages::CancelHistoricalData
    )
}
...
pub(crate) fn encode_request_histogram_data(
    request_id: i32,
    contract: &Contract,
    use_rth: bool,
    period: BarSize,
...
pub(crate) fn encode_cancel_histogram_data(request_id: i32) -> Result<Vec<u8>, Error> {
    crate::proto::encoders::encode_cancel_by_id!(
        request_id,
        CancelHistogramData,
        crate::messages::OutgoingMessages::CancelHistogramData
    )
}
...
pub(crate) fn encode_cancel_head_timestamp(request_id: i32) -> Result<Vec<u8>, Error> {
    crate::proto::encoders::encode_cancel_by_id!(
        request_id,
        CancelHeadTimestamp,
        crate::messages::OutgoingMessages::CancelHeadTimestamp
    )
}
