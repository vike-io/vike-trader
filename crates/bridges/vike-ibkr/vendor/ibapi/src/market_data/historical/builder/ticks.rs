...
impl<'a> HistoricalTicksBuilder<'a, crate::client::sync::Client> {
    ...
    pub fn trade(
        self,
    ) -> Result<crate::market_data::historical::sync::TickSubscription<TickLast>, Error> {
    ...
    pub fn mid_point(
        self,
    ) -> Result<crate::market_data::historical::sync::TickSubscription<TickMidpoint>, Error> {
    ...
    ) -> Result<crate::market_data::historical::sync::TickSubscription<TickBidAsk>, Error> {
