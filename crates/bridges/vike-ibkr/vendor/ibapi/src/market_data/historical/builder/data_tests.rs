...
use crate::testdata::builders::market_data::{
    historical_data_bar, historical_data_end_response, historical_data_response,
};
...
fn assert_stream_invalid_argument_sync(
    result: Result<
        crate::subscriptions::sync::Subscription<
            crate::market_data::historical::HistoricalBarUpdate,
        >,
        crate::Error,
    >,
) {
...
fn assert_stream_invalid_argument_async(
    result: Result<
        crate::subscriptions::r#async::Subscription<
            crate::market_data::historical::HistoricalBarUpdate,
        >,
        crate::Error,
    >,
...
mod sync_tests {
    ...
    use crate::common::test_utils::helpers::{
        assert_request, create_blocking_test_client_with_responses_and_version, TEST_REQ_ID_FIRST,
    };
    ...
    fn fetch_without_date_spec_errors() {
        let (client, _bus) = create_blocking_test_client_with_responses_and_version(
            vec![],
...
mod async_tests {
    ...
    use crate::common::test_utils::helpers::{
        assert_request, create_test_client_with_responses_and_version, TEST_REQ_ID_FIRST,
    };
    use crate::contracts::Contract;
    use crate::market_data::historical::{BarSize, Duration, ToDuration, WhatToShow};
    use crate::server_versions;
    ...
    async fn fetch_without_date_spec_errors() {
        let (client, _bus) =
            create_test_client_with_responses_and_version(vec![], server_versions::SIZE_RULES);
        let contract = Contract::stock("AAPL").build();
