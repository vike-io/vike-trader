...
pub mod helpers {
    ...
    pub fn create_test_client_with_responses(
        responses: Vec<String>,
    ) -> (Client, Arc<MessageBusStub>) {
        let message_bus = Arc::new(MessageBusStub {
            request_messages: RwLock::new(vec![]),
    ...
    pub fn create_test_client_with_responses_and_version(
        responses: Vec<String>,
        server_version: i32,
    ) -> (Client, Arc<MessageBusStub>) {
        let message_bus = Arc::new(MessageBusStub {
    ...
    pub fn create_test_client_with_ordered_proto_responses(
    ...
    #[cfg(feature = "sync")]
    pub fn create_blocking_test_client_with_version(
        server_version: i32,
    ...
    #[cfg(feature = "sync")]
    pub fn create_blocking_test_client_with_responses(
        responses: Vec<String>,
    ) -> (crate::client::blocking::Client, Arc<MessageBusStub>) {
        create_blocking_test_client_with_responses_and_version(
            responses,
    ...
    pub fn create_blocking_test_client_with_ordered_proto_responses(
        ...
        let message_bus = Arc::new(MessageBusStub::with_ordered_responses(responses));
        let client = crate::client::blocking::Client::stubbed(
            message_bus.clone(),
            server_versions::SIZE_RULES,
        );
        (client, message_bus)
    ...
    pub fn assert_request_msg_id(
        message_bus: &MessageBusStub,
        index: usize,
        expected: crate::messages::OutgoingMessages,
    ) {
    ...
    pub fn decode_request_proto<T: prost::Message + Default>(
        message_bus: &MessageBusStub,
        index: usize,
    ) -> T {
        let request_messages = message_bus.request_messages.read().unwrap();
    ...
    pub fn assert_request_proto<T>(
        message_bus: &MessageBusStub,
        index: usize,
        expected_msg_id: crate::messages::OutgoingMessages,
        expected: &T,
    ) where
    ...
    pub fn assert_request<B: crate::testdata::builders::RequestEncoder>(
        message_bus: &MessageBusStub,
        index: usize,
        expected: &B,
    ) {
    ...
    pub fn proto_response(
        msg_type: crate::messages::IncomingMessages,
        bytes: Vec<u8>,
    ) -> crate::messages::ResponseMessage {
    ...
    pub fn managed_accounts_frame(accounts: &str) -> Vec<u8> {
        binary_proto(
            ...
            &crate::proto::ManagedAccounts { accounts_list: Some(accounts.to_string()) },
        )
    }
    ...
    pub fn error_frame(request_id: i32, code: i32, msg: impl Into<String>) -> Vec<u8> {
        binary_proto(
            ...
            &error_envelope(request_id, code, msg),
        )
    }
    ...
    pub fn assert_tws_error_message(
        err: crate::Error,
        expected_code: i32,
...
pub mod wire_enum {
    ...
    where
        T: Copy
            ...
            + std::fmt::Debug
            + PartialEq
            + std::str::FromStr<Err = crate::Error>
            + crate::ToField,
    {
