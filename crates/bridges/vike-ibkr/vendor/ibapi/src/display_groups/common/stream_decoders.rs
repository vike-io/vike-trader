...
impl StreamDecoder<DisplayGroupUpdate> for DisplayGroupUpdate {
    ...
    fn cancel_message(
        ...
        let request_id =
            error_helpers::require_request_id_for(request_id, "unsubscribe from group events")?;
