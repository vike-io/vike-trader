...
#[cfg(feature = "sync")]
static CURRENT_INTERACTION_SYNC: StdRwLock<Option<Arc<StdRwLock<Interaction>>>> =
    StdRwLock::new(None);

#[cfg(feature = "async")]
static CURRENT_INTERACTION_ASYNC: TokioRwLock<Option<Arc<TokioRwLock<Interaction>>>> =
    TokioRwLock::const_new(None);
