...
use crate::proto::encoders::{
    encode_contract, encode_contract_with_order, encode_execution_filter, encode_order,
    encode_order_cancel, some_bool, some_str,
};
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::OpenOrder {
            ...
            contract: Some(proto::Contract {
                ...
                symbol: Some(self.symbol.clone()),
                sec_type: Some(self.security_type.clone()),
                last_trade_date_or_contract_month: some_str(
...
impl Default for ExecutionDataEndResponse {
    fn default() -> Self {
        Self { request_id: TEST_REQ_ID_FIRST }
    }
}
...
impl ResponseProtoEncoder for ExecutionDataEndResponse {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::ExecutionDetailsEnd { req_id: Some(self.request_id) }
    }
}
...
impl Default for PlaceOrderRequestBuilder {
    fn default() -> Self {
        Self { order_id: 13, contract: Contract::default(), order: Order::default() }
    }
}
...
impl Default for CancelOrderRequestBuilder {
    fn default() -> Self {
        Self { order_id: 13, manual_order_cancel_time: String::new() }
    }
}
...
impl RequestEncoder for AutoOpenOrdersRequestBuilder {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::AutoOpenOrdersRequest { auto_bind: some_bool(self.auto_bind) }
    }
}
...
impl RequestEncoder for CompletedOrdersRequestBuilder {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::CompletedOrdersRequest { api_only: some_bool(self.api_only) }
    }
}
...
impl Default for ExecutionsRequestBuilder {
    fn default() -> Self {
        Self { request_id: TEST_REQ_ID_FIRST, filter: ExecutionFilter::default() }
    }
}
