...
impl Default for ContractDataRequestBuilder {
    fn default() -> Self {
        Self { request_id: TEST_REQ_ID_FIRST, contract: Contract::default() }
    }
}
...
impl Default for MatchingSymbolsRequestBuilder {
    fn default() -> Self {
        Self { request_id: TEST_REQ_ID_FIRST, pattern: String::new() }
    }
}
...
impl RequestEncoder for MarketRuleRequestBuilder {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::MarketRuleRequest { market_rule_id: Some(self.market_rule_id) }
    }
}
...
impl Default for SmartComponentsRequestBuilder {
    fn default() -> Self {
        Self { request_id: TEST_REQ_ID_FIRST, bbo_exchange: String::new() }
    }
}
...
single_req_id_request_builder!(
    CancelContractDataRequestBuilder,
    CancelContractData,
...
impl SmartComponentsResponse {
    pub fn component(
        ...
        exchange_letter: impl Into<String>,
    ) -> Self {
...
pub fn market_rule(market_rule_id: i32) -> MarketRuleResponse {
    MarketRuleResponse { market_rule_id, price_increments: Vec::new() }
}
