...
use crate::common::test_utils::helpers::constants::{
    TEST_ACCOUNT, TEST_CONTRACT_ID, TEST_MODEL_CODE, TEST_TICKER_ID,
};
...
impl Default for ManagedAccountsResponse {
    fn default() -> Self {
        Self { accounts: vec![TEST_ACCOUNT.to_string(), "DU7654321".to_string()] }
    }
}
...
impl ResponseProtoEncoder for ManagedAccountsResponse {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::ManagedAccounts { accounts_list: Some(self.accounts.join(",")) }
    }
}
...
impl Default for AccountUpdateTimeResponse {
    fn default() -> Self {
        Self { timestamp: "14:30:00".to_string() }
    }
}
...
impl ResponseProtoEncoder for AccountUpdateTimeResponse {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::AccountUpdateTime { time_stamp: Some(self.timestamp.clone()) }
    }
}
...
impl Default for AccountDownloadEndResponse {
    fn default() -> Self {
        Self { account: TEST_ACCOUNT.to_string() }
    }
}
...
impl ResponseProtoEncoder for AccountDownloadEndResponse {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::AccountDataEnd { account_name: Some(self.account.clone()) }
    }
}
...
impl ResponseProtoEncoder for CurrentTimeResponse {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::CurrentTime { current_time: Some(self.timestamp) }
    }
}
...
impl ResponseProtoEncoder for CurrentTimeInMillisResponse {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::CurrentTimeInMillis { current_time_in_millis: Some(self.millis) }
    }
}
...
impl ResponseEncoder for PnLResponse {
    fn fields(&self) -> Vec<String> {
        let mut fields =
            vec!["94".to_string(), self.request_id.to_string(), self.daily_pnl.to_string()];
...
impl Default for AccountUpdatesRequestBuilder {
    fn default() -> Self {
        Self { subscribe: true, account: Some(TEST_ACCOUNT.to_string()) }
    }
}
...
impl RequestEncoder for FaRequestBuilder {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::FaRequest { fa_data_type: Some(self.fa_data_type) }
    }
}
...
impl ResponseProtoEncoder for ReceiveFaResponse {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::ReceiveFa { fa_data_type: Some(self.fa_data_type), xml: Some(self.xml.clone()) }
    }
}
...
impl ResponseProtoEncoder for ReplaceFaEndResponse {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::ReplaceFaEnd { req_id: Some(self.request_id), text: Some(self.text.clone()) }
    }
}
...
impl RequestEncoder for SetServerLogLevelRequestBuilder {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::SetServerLogLevelRequest { log_level: Some(self.log_level) }
    }
}
...
impl ResponseProtoEncoder for VerifyMessageApiResponse {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::VerifyMessageApi { api_data: Some(self.api_data.clone()) }
    }
}
...
impl RequestEncoder for VerifyMessageRequestBuilder {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::VerifyMessageRequest { api_data: Some(self.api_data.clone()) }
    }
}
...
pub fn cancel_account_updates() -> AccountUpdatesRequestBuilder {
    AccountUpdatesRequestBuilder { subscribe: false, account: None }
}
