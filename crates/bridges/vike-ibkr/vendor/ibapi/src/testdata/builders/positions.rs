...
use crate::common::test_utils::helpers::constants::{
    TEST_ACCOUNT, TEST_CONTRACT_ID, TEST_TICKER_ID,
};
...
impl Default for PositionsMultiRequestBuilder {
    fn default() -> Self {
        Self { request_id: TEST_TICKER_ID, account: TEST_ACCOUNT.to_string(), model_code: None }
    }
}
...
impl RequestEncoder for CancelPositionsMultiRequestBuilder {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::CancelPositionsMulti { req_id: Some(self.request_id) }
    }
}
