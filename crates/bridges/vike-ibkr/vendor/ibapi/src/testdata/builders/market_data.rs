...
impl Default for HeadTimestampResponse {
    fn default() -> Self {
        Self { request_id: TEST_REQ_ID_FIRST, head_timestamp: "1678323335".to_string() }
    }
}
...
impl Default for HistoricalDataResponse {
    fn default() -> Self {
        Self { request_id: TEST_REQ_ID_FIRST, bars: Vec::new() }
    }
}
...
impl Default for HistoricalDataUpdateResponse {
    fn default() -> Self {
        Self { request_id: TEST_REQ_ID_FIRST, bar: None }
    }
}
...
impl Default for HistoricalTicksResponse {
    fn default() -> Self {
        Self { request_id: TEST_REQ_ID_FIRST, ticks: Vec::new(), done: true }
    }
}
...
pub fn historical_tick_bid_ask(
    time: i64,
    price_bid: f64,
    price_ask: f64,
    size_bid: i32,
...
impl Default for HistogramDataResponse {
    fn default() -> Self {
        Self { request_id: TEST_REQ_ID_FIRST, entries: Vec::new() }
    }
}
...
impl ResponseProtoEncoder for TradeTickResponse {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::TickByTickData {
            ...
            tick: Some(proto::tick_by_tick_data::Tick::HistoricalTickLast(
...
impl ResponseProtoEncoder for BidAskTickResponse {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::TickByTickData {
            req_id: Some(self.request_id),
            tick_type: Some(3),
            tick: Some(proto::tick_by_tick_data::Tick::HistoricalTickBidAsk(
...
impl Default for MidPointTickResponse {
    fn default() -> Self {
        Self { request_id: TEST_REQ_ID_FIRST, time: 0, mid_point: 0.0 }
    }
}
...
impl ResponseProtoEncoder for MidPointTickResponse {
    ...
    fn to_proto(&self) -> Self::Proto {
        proto::TickByTickData {
            req_id: Some(self.request_id),
            tick_type: Some(4),
            tick: Some(proto::tick_by_tick_data::Tick::HistoricalTickMidPoint(
...
impl Default for TickPriceResponse {
    fn default() -> Self {
        Self { request_id: TEST_REQ_ID_FIRST, tick_type: 0, price: 0.0, size: None, attr_mask: 0 }
    }
}
...
impl Default for TickSizeResponse {
    fn default() -> Self {
        Self { request_id: TEST_REQ_ID_FIRST, tick_type: 0, size: 0.0 }
    }
}
...
impl Default for TickStringResponse {
    fn default() -> Self {
        Self { request_id: TEST_REQ_ID_FIRST, tick_type: 0, value: String::new() }
    }
}
...
impl Default for TickGenericResponse {
    fn default() -> Self {
        Self { request_id: TEST_REQ_ID_FIRST, tick_type: 0, value: 0.0 }
    }
}
