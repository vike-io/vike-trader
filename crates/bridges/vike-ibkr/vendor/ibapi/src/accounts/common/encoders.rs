...
pub(in crate::accounts) fn encode_request_positions() -> Result<Vec<u8>, Error> {
    crate::proto::encoders::encode_empty_proto!(
        PositionsRequest,
...
pub(in crate::accounts) fn encode_request_account_summary(
    request_id: i32,
    group: &AccountGroup,
    tags: &[&str],
) -> Result<Vec<u8>, Error> {
...
pub(in crate::accounts) fn encode_cancel_account_summary(
    request_id: i32,
) -> Result<Vec<u8>, Error> {
...
pub(in crate::accounts) fn encode_request_pnl(
    request_id: i32,
    account: &AccountId,
...
pub(in crate::accounts) fn encode_request_pnl_single(
    ...
    Ok(encode_protobuf_message(OutgoingMessages::RequestPnLSingle as i32, &request.encode_to_vec()))
}
...
pub(in crate::accounts) fn encode_cancel_positions_multi(
    request_id: i32,
) -> Result<Vec<u8>, Error> {
    crate::proto::encoders::encode_cancel_by_id!(
        request_id,
...
pub(in crate::accounts) fn encode_request_account_updates(
    subscribe: bool,
    account: &AccountId,
) -> Result<Vec<u8>, Error> {
    use crate::messages::encode_protobuf_message;
...
pub(in crate::accounts) fn encode_cancel_account_updates() -> Result<Vec<u8>, Error> {
    use crate::messages::encode_protobuf_message;
    use prost::Message;
    let request = crate::proto::AccountDataRequest { subscribe: Some(false), acct_code: None };
    Ok(encode_protobuf_message(
        OutgoingMessages::RequestAccountData as i32,
        &request.encode_to_vec(),
    ))
...
pub(in crate::accounts) fn encode_cancel_account_updates_multi(
    request_id: i32,
) -> Result<Vec<u8>, Error> {
    crate::proto::encoders::encode_cancel_by_id!(
        request_id,
...
pub(in crate::accounts) fn encode_request_soft_dollar_tiers(
    request_id: i32,
) -> Result<Vec<u8>, Error> {
    crate::proto::encoders::encode_cancel_by_id!(
        request_id,
...
pub(in crate::accounts) fn encode_request_fa(fa_data_type: i32) -> Result<Vec<u8>, Error> {
    use crate::messages::encode_protobuf_message;
    use prost::Message;
    let request = crate::proto::FaRequest { fa_data_type: Some(fa_data_type) };
    Ok(encode_protobuf_message(OutgoingMessages::RequestFA as i32, &request.encode_to_vec()))
}

pub(in crate::accounts) fn encode_replace_fa(
    request_id: i32,
    fa_data_type: i32,
    xml: &str,
) -> Result<Vec<u8>, Error> {
...
pub(in crate::accounts) fn encode_set_server_log_level(log_level: i32) -> Result<Vec<u8>, Error> {
    ...
    Ok(encode_protobuf_message(OutgoingMessages::ChangeServerLog as i32, &request.encode_to_vec()))
}

pub(in crate::accounts) fn encode_verify_request(
    api_name: &str,
    api_version: &str,
) -> Result<Vec<u8>, Error> {
    use crate::messages::encode_protobuf_message;
...
pub(in crate::accounts) fn encode_verify_message(api_data: &str) -> Result<Vec<u8>, Error> {
    use crate::messages::encode_protobuf_message;
    use prost::Message;
    let request = crate::proto::VerifyMessageRequest { api_data: Some(api_data.to_string()) };
