...
pub enum SubscriptionType {
    PnL { account: String, model_code: Option<String> },
    PnLSingle { account: String, contract_id: i32, model_code: Option<String> },
    Positions,
    PositionsMulti { account: Option<String>, model_code: Option<String> },
    AccountSummary { group: String, tags: Vec<String> },
}
...
pub const VERSION_TEST_CASES: &[VersionTestCase] = &[
    VersionTestCase { function_name: "PnL", required_version: server_versions::PNL },
    VersionTestCase {
    ...
    VersionTestCase { function_name: "Positions", required_version: server_versions::POSITIONS },
];
