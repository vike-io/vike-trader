...
fn test_encode_request_account_summary() {
    ...
    let bytes =
        super::encode_request_account_summary(3000, &group, &["AccountType", "NetLiquidation"])
            .unwrap();
...
fn test_encode_request_positions_multi() {
    ...
    let bytes =
        super::encode_request_positions_multi(9000, Some(&account), Some(&model_code)).unwrap();
...
fn test_encode_request_account_updates_multi() {
    ...
    let bytes =
        super::encode_request_account_updates_multi(9000, Some(&account), Some(&model_code))
            .unwrap();
