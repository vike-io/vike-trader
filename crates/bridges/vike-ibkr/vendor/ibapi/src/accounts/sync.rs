...
impl Client {
    ...
    pub fn positions_multi(
        ...
        let request =
            encoders::encode_request_positions_multi(builder.request_id(), account, model_code)?;
    ...
    pub fn pnl(
        ...
        crate::common::request_helpers::blocking::request_with_id(self, Features::PNL, |id| {
            encoders::encode_request_pnl(id, account, model_code)
        })
    }
    ...
    pub fn pnl_single(
        ...
        crate::common::request_helpers::blocking::request_with_id(
            self,
            Features::REALIZED_PNL,
            |id| encoders::encode_request_pnl_single(id, account, contract_id, model_code),
        )
    }
    ...
    pub fn account_summary(
        ...
        crate::common::request_helpers::blocking::request_with_id(
            self,
            Features::ACCOUNT_SUMMARY,
            |id| encoders::encode_request_account_summary(id, group, tags),
        )
    }
    ...
    pub fn account_updates(
        ...
        crate::common::request_helpers::blocking::shared_request(
            self,
    ...
    pub fn account_updates_multi(
        ...
        let builder = self.request();
        let request = encoders::encode_request_account_updates_multi(
            builder.request_id(),
            account,
            model_code,
        )?;
