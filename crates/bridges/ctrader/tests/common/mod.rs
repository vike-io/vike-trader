...
use vike_ctrader::proto::{
    ProtoMessage, ProtoOaAccountAuthRes, ProtoOaApplicationAuthRes, ProtoOaClosePositionReq,
    ...
    ProtoOaTradeData, ProtoOaTradeSide, ProtoOaTrader, ProtoOaTraderRes, ProtoOaTrendbar, pt,
};
