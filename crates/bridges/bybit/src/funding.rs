...
//! `BalanceMode::Delta` but flip `Authoritative` on the first venue wallet frame
//! (`Account::apply_account_state`, absolute assignment) and on every reconcile pass
//! (`ReconClient::fetch_balance` seeds `Account::balance` absolutely — see
