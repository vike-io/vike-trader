...
//! carried a HARDCODED venue literal in each venue's body (`crate::spot::VENUE` = `"binance"` /
...
/// wrapper passes `crate::spot::VENUE`). `clientOrderId` is broker-prefix stripped (unified
