...
//!   [`vike_model::AssetClass::CryptoPerp`] into linear and inverse (*"the vocabulary names the
...
/// from the string.
///
/// The two arms are different PRODUCTS in `vike_model::AssetClass` terms (`CryptoPerp` vs
