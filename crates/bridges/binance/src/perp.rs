...
/// NOT the canonical venue id ([`crate::spot::VENUE`] stays `"binance"` everywhere an
...
/// `"binance"` venue key (`crate::spot::VENUE`). Keeps its 1-arg signature so the reconcile call
...
pub fn map_perp_open_order(o: &Value) -> ManagedOrder {
    crate::family::order_map::map_perp_open_order(o, crate::spot::VENUE)
}
