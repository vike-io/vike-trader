...
use vike_binance::perp::{
    parse_binance_perp_instruments, BinancePerpRest, DEMO_FAPI_REST,
    PATH_EXCHANGE_INFO as FAPI_EXCHANGE_INFO, PATH_OPEN_ORDERS as FAPI_OPEN_ORDERS,
    PATH_ORDER as FAPI_ORDER,
};
use vike_binance::spot::{
    parse_symbol_properties, BinanceSpotRest, DEMO_REST, PATH_EXCHANGE_INFO, PATH_OPEN_ORDERS,
    PATH_ORDER,
};
