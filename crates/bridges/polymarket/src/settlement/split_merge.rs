...
use crate::redeem::{bytes32_from_hex, Era};
use crate::redeem_relayer::{
    build_wallet_call_request, submit_wallet_call, RedeemRequest, RedeemResult,
};
...
mod tests {
    ...
    fn convert_relayer_request_shape_and_routing() {
        ...
        assert!(build_convert_request(KEY, PROXY, "0xdead", index_set, ONE_USDC, 0, 0, Era::V2)
            .is_err());
