...
#[cfg(feature = "polymarket")]
pub use auto_redeem::{
    AutoRedeemPoller, ProdDeps, RedeemDeps, RedeemTickReport, auto_redeem_enabled,
    kill_switch_tripped, redeem_once,
};
pub use catalog::{MarketCatalog, PolymarketCatalog, markets_to_instruments};
#[cfg(feature = "polymarket")]
pub use chain::{
    CHAIN_WATCH_ENV, ChainOracle, ChainResolution, ChainSettlement, ChainTick, ChainWatchPoller,
    ChainWatcher, DEFAULT_RPC_URL, PolygonRpc, RPC_URL_ENV, RedeemVenue, Redemption,
    ResolutionEvent, TOPIC_CONDITION_RESOLUTION, TOPIC_CTF_PAYOUT_REDEMPTION,
...
#[cfg(feature = "polymarket")]
pub use heartbeat::{
    BeatReport, DEFAULT_BEAT_INTERVAL, HEARTBEAT_ENV, HEARTBEAT_PATH, HeartbeatPoller,
    HeartbeatState, HeartbeatTransport, ProdTransport, beat_once, heartbeat_enabled,
};
#[cfg(feature = "polymarket")]
...
pub use market_feed::{
    DEFAULT_TOKENS_PER_SOCKET, Feeds, MarketStream, PumpMode, PumpTiming, TOKENS_PER_SOCKET_ENV,
    TokenSlot, TokenState, Watchdog, run_session, run_shard_session,
};
#[cfg(feature = "polymarket")]
pub use mount::{
...
pub use resolve::{
    ...
    WINNER_PAYOUT, WatchEntry, ambiguous_conditions, payout_for, pm_resolve_enabled,
    resolved_conditions, settle_once, settlement_fill, settlement_key, settlement_trade_id,
    winning_tokens,
};
