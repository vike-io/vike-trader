...
#[cfg(feature = "polymarket")]
pub use auto_redeem::{
    AutoRedeemHandle, AutoRedeemPoller, ProdDeps, RedeemDeps, RedeemTickReport,
    auto_redeem_enabled, kill_switch_tripped, redeem_once,
};
pub use catalog::{MarketCatalog, PolymarketCatalog, markets_to_instruments};
#[cfg(feature = "polymarket")]
pub use chain::{
    CHAIN_WATCH_ENV, ChainOracle, ChainResolution, ChainSettlement, ChainTick, ChainWatchHandle,
    ChainWatchPoller, ChainWatcher, DEFAULT_RPC_URL, PolygonRpc, RPC_URL_ENV, RedeemVenue,
    Redemption, ResolutionEvent, TOPIC_CONDITION_RESOLUTION, TOPIC_CTF_PAYOUT_REDEMPTION,
    TOPIC_NEG_RISK_PAYOUT_REDEMPTION, TokenTransfer, chain_watch_enabled,
    decode_condition_resolution, decode_ctf_redemption, decode_neg_risk_redemption,
...
pub use egress::{
    DEFAULT_EGRESS_PROBE, Egress, EgressCheck, GEOBLOCK_URL, Geoblock, GeoblockVerdict,
...
pub use exec::{
    ...
    get_signed, get_trades, plan_cancels, rate_gate_enforced, rate_gate_would_block_count,
...
#[cfg(feature = "polymarket")]
pub use heartbeat::{
    BeatReport, DEFAULT_BEAT_INTERVAL, HEARTBEAT_ENV, HEARTBEAT_PATH, HeartbeatHandle,
    HeartbeatPoller, HeartbeatState, HeartbeatTransport, ProdTransport, beat_once,
    heartbeat_enabled,
};
#[cfg(feature = "polymarket")]
...
pub use market_feed::{
    DEFAULT_TOKENS_PER_SOCKET, Feeds, MarketStream, PumpMode, PumpTiming, StreamErr,
    TOKENS_PER_SOCKET_ENV, TokenSlot, TokenState, Watchdog, run_session, run_shard_session,
};
#[cfg(feature = "polymarket")]
pub use mount::{
...
#[cfg(feature = "polymarket")]
pub use positions::{
    DATA_API, Payout, Position, PositionsClient, WinnerSource, parse_positions, payout_of,
    redeemable, redeemable_by, resolved_candidates,
};
#[cfg(feature = "polymarket")]
pub use rate_budget::{
...
pub use resolve::{
    ...
    ResolveDeps, ResolveHandle, ResolvePoller, ResolveWatchlist, SettleTickReport,
    SettlementLedger, WINNER_PAYOUT, WatchEntry, ambiguous_conditions, payout_for,
    pm_resolve_enabled, resolved_conditions, settle_once, settlement_fill, settlement_key,
    settlement_trade_id, winning_tokens,
};
...
#[cfg(feature = "polymarket")]
pub use user_data::{
    PolymarketUserDataResync, WS_USER, open_polymarket_user_data_ws, spawn_polymarket_user_data,
...
#[cfg(feature = "polymarket")]
pub use l1::{DerivedL2, clob_auth_signature, derive_api_key, ensure_l2, l1_headers};
#[cfg(feature = "polymarket")]
pub use redeem::{
...
#[cfg(feature = "polymarket")]
pub use redeem_confirm::{ChainRedeemConfirmer, MIN_CONFIRMATIONS, RedeemConfirmation};
#[cfg(feature = "polymarket")]
...
#[cfg(feature = "polymarket")]
pub use auth::{PolyAuthError, l2_auth_headers, l2_signature};
pub use config::{
