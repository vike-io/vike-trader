...
fn main() {
    ...
    println!("  Event with Box<FillEvent> would shrink to ~= the next-largest non-fill variant");
    {
        ...
        println!("     String {:>2} · Ustr {:>2} · Option<String> {:>2} · Option<f64> {:>2} · Coid {:>2} · enum {:>2}",
            std::mem::size_of::<String>(), std::mem::size_of::<Ustr>(),
            std::mem::size_of::<Option<String>>(), std::mem::size_of::<Option<f64>>(),
            std::mem::size_of::<Coid>(), std::mem::size_of::<vike_model::events::PositionSide>());
    }
