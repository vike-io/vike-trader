...
/// How many key/value pairs one `boot_settings` record may carry. The ceiling set is four
/// (`vike_config::Policy` has exactly four fields); 8 leaves room for one more without reopening
/// the size arithmetic.
