...
//!
//! `crates/vike-journal/src/lock.rs` refuses a second writer on one journal directory, and
...
//!   (`crates/vike-journal/src/record.rs`) round-trips the origin for free, so a replay
