...
use vike_chart::studies::{ActiveStudy, get_study};
use vike_marketdata::{BookLevel, L2Book, TradeTick};
...
fn book(bid_q: f64, ask_q: f64) -> L2Book {
    ...
    b.apply_snapshot(
        1,
        &[BookLevel::new(99.0, bid_q), BookLevel::new(98.5, bid_q)],
        &[BookLevel::new(101.0, ask_q), BookLevel::new(101.5, ask_q)],
    );
    b
}
