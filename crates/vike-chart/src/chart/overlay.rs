...
const TAG_BG: Color32 = palette::BORDER; // crosshair tag bg (vike)
const TAG_TX: Color32 = palette::TEXT; // crosshair tag text
...
fn tag_text_on(bg: Color32) -> Color32 {
    ...
    if luma > 140.0 {
        palette::BG // dark — legible on a light chip
    } else {
