...
//! rather than a hole. `crates/vike-ops/tests/journal_scratch_gate.rs` holds a STRICT rule for
...
// `crates/vike-core/src/replay.rs`'s `ReplayError::Truncated`, so it is part of this crate's
...
const VERSION: u32 = 16; // added MintedSubmit.route_key + MarginCallLiquidate.route_key (15: AccountState.route_key; 14: MarginCallLiquidate.mount_id; 13: Snap.mount_attr; 12: ScheduleFire; 11: Snap.contingencies; 10: GtdExpire; 9: MarginCallLiquidate; 8: Snap.conditionals; 7: ConditionalDisarmed + Snap.arm_seq; 6: ConditionalArmed/Fire; 5: PortfolioSnap; 4: MintedSubmit; 3: StrategySubmit; 2 before)
...
mod tests {
    ...
    fn readable_version_range_is_4_to_16() {
        ...
        assert!(
            ...
            "v15 (AccountState.route_key era) stays readable"
        );
        assert!(
