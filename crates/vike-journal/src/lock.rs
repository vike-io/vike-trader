...
mod tests {
    ...
    /// Hold the guard for the whole test — see `crates/vike-journal/src/testutil.rs`'s `Scratch`,
    /// which carries why this crate owns one rather than reaching vike-core's.
