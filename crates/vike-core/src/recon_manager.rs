...
/// * Key it by ROUTE KEY (`"binance#ALT"`, what `vike_run`'s account fan-out was keyed as) and the
...
impl ReconLeg {
    ...
    /// guards, two different sets — and `vike_run::mount_accounts_of` makes them diverge BY
