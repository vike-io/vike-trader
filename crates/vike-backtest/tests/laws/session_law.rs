...
use vike_catalog::{AssetClass, session_calendar_for};
use vike_model::BookLevel;
use vike_model::session::{CRYPTO_24_7, US_EQUITY_REGULAR};
use vike_model::{
    Bar, BookUpdate, BookUpdateKind, Broker, Fill, HftBroker, L2Book, SessionCalendar, Strategy,
    TradeTick, days_from_civil,
};
...
fn eq_book(ts: i64) -> Tick {
    Tick::Book(BookUpdate {
        ...
        tick_size: 0.01,
        bids: vec![BookLevel::new(99.0, 10.0)],
        asks: vec![BookLevel::new(101.0, 5.0)],
