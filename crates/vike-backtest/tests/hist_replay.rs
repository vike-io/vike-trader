...
use vike_model::{
    BookLevel, BookUpdate, BookUpdateKind, Broker, L2Book, QuoteTick, SymbolProperties, TradeTick,
};
...
fn book_and_quote_replay_close_the_loop() {
    ...
    let books = vec![
        ...
        bu(1500, 2, BookUpdateKind::Delta, vec![BookLevel::new(0.46, 3.0)], vec![]), // best bid -> 0.46
    ];
