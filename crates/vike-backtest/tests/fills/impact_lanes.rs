...
use vike_model::{
    Bar, BookLevel, BookUpdate, BookUpdateKind, L2Book, QuoteTick, Strategy, TradeTick,
    book_taker_price,
};
...
fn book_tick(ts: i64) -> Tick {
    Tick::Book(BookUpdate {
        ...
        bids: vec![
            BookLevel::new(101.0, 400.0),
            BookLevel::new(100.5, 400.0),
            BookLevel::new(100.0, 4_000.0),
        ],
        asks: vec![
            BookLevel::new(102.0, 400.0),
            BookLevel::new(102.5, 400.0),
            BookLevel::new(103.0, 4_000.0),
        ],
        symbol: SYM.to_string(),
    })
}
