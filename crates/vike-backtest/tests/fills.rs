...
//! - `impact_lanes` — the same model on the TICK and L2 replay lanes, and the terms each is
//!   charged (the L2 walk has already paid the temporary half).
