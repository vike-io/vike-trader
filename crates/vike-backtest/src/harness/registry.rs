...
//! and the `rhai` script arm. ⚠ That arm's reason for staying here CHANGED on 2026-09-23 and the
...
use vike_strategy::cheap_np::CheapNp;
use vike_strategy::sport_taker::SportTaker;
...
pub fn strategy_by_name(
    ...
    match name {
        ...
        // `vike_strategy::sport_taker`'s module doc for the grammar.
