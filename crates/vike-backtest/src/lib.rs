...
// `backtest data fetch` — real public bars into the store. Gated by its own feature: the venue
...
pub use engine::{
    ...
    OptionExpirySource, OptionRight, OptionSpec, RESOLUTION_PROBE_SENTINEL, ResolutionSource,
    SettlementFill, SimBroker, StrategyEngine, Tick, VariationSettlement, format_instrument,
};
