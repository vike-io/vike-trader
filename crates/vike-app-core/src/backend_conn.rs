...
/// [`crate::backend_registry::DEFAULT_OBSERVE_ADDR`]. `crates/vike-app/src/main.rs` wrapped that
...
/// `crates/vike-app/src/app_ui.rs`'s `dispatch` resolved to the read-only no-op. **The GUI could
