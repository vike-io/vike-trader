...
/// The master gate for wiring a `vike-app --observe` observer's Scope::Write write path: `true`
...
/// Render the one-line remote **Scope::Write** channel summary the GUI status bar shows when a
