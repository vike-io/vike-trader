...
mod test_support {
    ...
    pub fn sync(
        ...
        sync_with(st, snap, spawned, hidden, trades, bf_rx, feed_status, None, None);
    }
    ...
    pub fn sync_gaps(
        ...
        sync_with(st, snap, spawned, hidden, trades, bf_rx, feed_status, None, Some(tape_gaps));
    }
    ...
    pub fn sync_direct(
        ...
        sync_with(st, snap, spawned, hidden, trades, bf_rx, feed_status, Some(direct_bars), None);
    }
