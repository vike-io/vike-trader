...
//!   - [`title_bar`] — a tool window's title bar, and the tab slot a tabbed tool seats its
//!     segmented control in (moved down out of the CI-excluded shell)
...
pub use state::{
    BodyBounds, DEFAULT_VENUE, TOOL_BODY_MARGIN, WinKind, WinState, series_key, show_window,
};
pub use title_bar::{TitleTabSlot, ToolTitleActions, tool_title_bar};
