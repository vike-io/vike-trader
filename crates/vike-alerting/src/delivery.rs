...
///
/// Owner ruling 2026-09-16: restrict what a process materialises. `crates/vike-datahub/src/recorder.rs`
/// mounts alerting on a daemon that trades nothing, and used to open the whole venue credential
/// store to reach these three names; it declares THIS constant as its scope instead. Living here
/// rather than at that call site is the point — a scope restated in the consuming crate could drift
/// from the reader, and the drift's symptom would be alerting silently delivering nowhere.
