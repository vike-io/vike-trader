...
//! problem even on paper — has its own mechanism in `crates/vike-journal/src/lock.rs` and is
//! not this file's job.
//!
//! RESIDUAL
...
//! # Mechanism
//!
//! The `crates/vike-journal/src/lock.rs` idiom — an OS advisory lock (`flock` /
