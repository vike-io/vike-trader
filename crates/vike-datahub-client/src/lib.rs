...
pub use proto::{
    ...
    FEATURE_DELETE_SERIES, FEATURE_MARKET_DATA, FEATURE_MD_VENUE_PREFIX, FEATURE_STUDY,
    MAX_FRAME_LEN, PROTO_VERSION, Plane, Request, Response, VerbScope, advertised_md_venues,
    md_venue_feature, plane_of, read_frame, read_frame_raw, read_frame_raw_capped, request_kind,
    required_scope, scope_admits, write_frame, wrong_plane_message,
};
