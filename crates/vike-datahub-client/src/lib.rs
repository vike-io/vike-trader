...
// verb in order to refuse it cleanly, and this crate has no `[features]` table to gate it with.
pub mod named_run;
pub mod node_auth;
pub mod proto;
pub mod remote;
...
pub use proto::{
    ...
    FEATURE_NAMED_RUN, FEATURE_SEARCH_METHOD, FEATURE_SEED_SERIES, FEATURE_STUDY,
    FEATURE_VENUE_CATALOG, FEATURE_WALKFORWARD_SEARCH, MAX_FRAME_LEN, PROTO_VERSION, Plane,
    Request, Response, SEARCH_METHODS, SeedDone, VerbScope, WireSearch, WireStudy,
