...
use crate::proto::{
    ...
    FEATURE_SEED_CLASS, FEATURE_SEED_SERIES, FEATURE_STUDY, FEATURE_VENUE_CATALOG,
    FEATURE_WALKFORWARD_SEARCH, PROTO_VERSION, Request, Response, SeedDone, WireSearch, WireStudy,
