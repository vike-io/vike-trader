...
impl DatahubClient {
    ...
    /// `crates/vike-cli/src/cmd/data/get.rs` requires a window before it ever reaches here.
    pub fn load_bars_ms(
        &mut self,
        venue: &str,
        symbol: &str,
    ...
    /// business: `crates/vike-cli/src/cmd/data/export.rs` walks a range in fixed wall-clock
