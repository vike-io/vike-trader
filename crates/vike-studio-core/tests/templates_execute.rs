...
//! [`vike_script::TEMPLATES`] is EXECUTED here — through the crate's own production
...
use vike_studio_core::{DataSlice, StoreHandle, StrategySpec, run_slice};
