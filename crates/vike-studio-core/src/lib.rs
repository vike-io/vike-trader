...
pub use run::{
    CompareOutcome, DataSlice, REPLAYABLE_TICK_KINDS, RunError, RunOutcome, SeriesLists, SliceKind,
    StoreHandle, StudioSweep, SweepEntry, UNREPLAYABLE_TICK_KIND, bar_series, build_strategy,
    build_strategy_with, compare_all_slice, depth_only_series, load_slice_bars, run_slice,
    run_sweep_slice, run_sweep_slice_with_params, run_walkforward_slice,
    run_walkforward_slice_with_params, series_lists, spawn_compare_all, spawn_outcome, spawn_run,
    spawn_sweep, spawn_walkforward, tick_series,
};
pub use spec::{
...
pub use wire_run::{
    ...
    to_data_slice, to_engine_params, to_strategy_spec, to_wire_result, to_wire_sweep_result,
