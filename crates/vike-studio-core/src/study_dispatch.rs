...
use crate::run::{spawn_outcome, StoreHandle};
use crate::study_run::{run_study, StudyRun, StudyRunError, StudyRunRequest};
...
/// `crates/vike-user-research/src/gen.rs` says the same of the compiled tier's scan. [`recipes`] is
/// that caller's half.
...
mod interpreted {
    ...
    use crate::rhai_study::RhaiStudy;
    use crate::study_run::{run_study_with, StudyRun, StudyRunError, StudyRunRequest};
