...
use vike_backtest::runs::{read_manifest, RunManifest, RunReadError, MANIFEST_FILE, REPORT_FILE};
...
use crate::user_strategies::load::{has_ext, stray_target, RHAI_EXT, RUST_EXT};
...
"#
    ...
    fn a_run_directory_with_no_manifest_is_reported_as_unfinished_not_dropped() {
        ...
        match &listing.diagnostics[..] {
            [ListingDiagnostic::RunUnfinished { run_id: a, report: true, .. }, ListingDiagnostic::RunUnfinished { run_id: b, report: false, .. }] =>
            {
