...
//! `vike-backend backtest --addr`, whose server lives in `vike-backtest` (layer 45). That crate
//! cannot name `vike-studio-core` (layer 50): the dependency direction is down-only and this crate
