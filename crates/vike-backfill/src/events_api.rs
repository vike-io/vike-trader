...
//! surface (`crates/vike-data/src/backtest_store.rs` carries why). What survives in this
...
//! `crates/vike-data/src/archive_store.rs`'s for the family day-file one. Three things this
//! endpoint does
