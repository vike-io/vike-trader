...
/// One concrete backfill dispatch: what [`crate::kline_source::backfill_kline_source`] will be
/// called with, for the source `run`'s pass resolved for this roster row.
