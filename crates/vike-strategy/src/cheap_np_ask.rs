...
//! | venue rule | decide at `T`, match against the book at `T + 250 ms`, rest if it no longer crosses | `vike_backtest::latency::VENUE_HOLD_POLYMARKET_UPDOWN_MS` + the L2 tier |
