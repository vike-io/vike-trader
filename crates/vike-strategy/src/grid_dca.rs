...
// this crate's own `tests/grid_dca_engine.rs`, reaching the simulator through the upward DEV edge
// the manifest declares — they lived in `vike-backtest`'s `tests/` until the Polymarket takers
// landed and brought them home. What stays below is the pure
