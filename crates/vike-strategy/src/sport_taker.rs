...
//! `vike_backtest::EngineParams::resolution` source settles at the binary payout. A tick whose symbol
...
//! `vike_backtest::EngineParams::latency_model` delays the submitted order's visibility by δ, and the
