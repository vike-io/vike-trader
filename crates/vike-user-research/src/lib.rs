...
//! registry below and writes the result through `crates/vike-model/src/runs.rs`. Why it lives
...
pub use contract::{
    CapturedStudyFit, MAX_ARTIFACT_NAME, StudyContext, StudyError, StudyFn, StudyLearner,
    StudyOutcome, valid_artifact_name,
};
