//! Unit tests for the PURE generator (`vike_user_research::gen`) on synthetic trees — the exact
...
use vike_user_research::gen::{render, rhai_tier, rust_tier, scan, valid_name, ScannedStudy};
